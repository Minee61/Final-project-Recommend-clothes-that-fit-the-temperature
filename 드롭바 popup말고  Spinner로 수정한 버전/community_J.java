...
public class community_J extends AppCompatActivity {
    ...
    // 필터 버튼
    private Spinner TempBn, WeatherBn, StyleBn ;
    // 새로 고침 버튼
    private Button fixBn;
    // 옷 이미지뷰
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> tempAdapter = new ArrayAdapter<>(this,
                ...
                new String[]{"전체", "0~24도", "25~40도"});
        tempAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        TempBn.setAdapter(tempAdapter);

        ArrayAdapter<String> weatherAdapter = new ArrayAdapter<>(this,
                android.R.layout.simple_spinner_item,
                new String[]{"전체", "맑음", "흐림", "비"});
        weatherAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        WeatherBn.setAdapter(weatherAdapter);

        ArrayAdapter<String> styleAdapter = new ArrayAdapter<>(this,
                android.R.layout.simple_spinner_item,
                new String[]{"전체", "캐주얼", "댄디", "스트릿"});
        styleAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        StyleBn.setAdapter(styleAdapter);

        TempBn.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                selecteTemp = tempAdapter.getItem(position);
                if (selecteTemp.equals("전체")) selecteTemp = "";
                RandomClothes();
            }
        ...
        WeatherBn.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                selecteWeather = weatherAdapter.getItem(position);
                if (selecteWeather.equals("전체")) selecteWeather = "";
                RandomClothes();
            }
        ...
        StyleBn.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                selecteStyle = styleAdapter.getItem(position);
                if (selecteStyle.equals("전체")) selecteStyle = "";
                RandomClothes();
            }
    ...
    private void RandomClothes() {
        ...
        for (int i = 0; i < makeshiftCloset.size(); i++) {
            ...
            if (c.imageClothes.equals("link1.jpg") || c.imageClothes.equals("link1.png")) {
                c.pick = true;
            } else if (c.imageClothes.equals("link2.jpg") || c.imageClothes.equals("link2.png")) {
                c.pick = false;
            }
    ...
    public void next(View view) {
        Intent intent = new Intent(community_J.this, bookMark_J.class);
        startActivity(intent);
    }
}
